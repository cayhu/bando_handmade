...
<body>
    <nav>
        <label class="logo" id="logo">BÔNG</label>
        <ul>
    ...
    <footer>
        <div class="social">
            <a href="https://www.facebook.com/profile.php?id=100061695790048"><i class="fa fa-facebook" aria-hidden="true"></i></a>
            <a href="https://www.facebook.com/profile.php?id=100061695790048"><i class="fa fa-twitter" aria-hidden="true"></i></a>
            <a href="https://www.facebook.com/profile.php?id=100061695790048"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        </div>
        <ul class="list">
            <li>
                <a href="./">Trang Chủ</a>
